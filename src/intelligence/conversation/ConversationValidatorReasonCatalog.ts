...
export const LAYER_1_REASON_CODES = new Set([
  ...
  "MISSING_INFO_ESCALATION_REASON_REQUIRED",
  "TRANSITION_AUTHORITY_DENIED",
...
export const LAYER_2_REASON_CODES = new Set([
  ...
  // The reply and safety fields may be sound while the model labels an
  // ordinary answer with an escalation next_action. Actual handoff safety
  // remains enforced independently by requires_escalation and handoff logic.
  ...
  "KNOWN_SELECTED_APP_REASKED",
  "KNOWN_PHONE_TYPE_REASKED",
  "KNOWN_WORK_MODEL_ACCEPTANCE_REASKED",
  "JOB_EXPLANATION_INCOMPLETE",
  "WORK_MODEL_NOT_DISCLOSED",
  "CLARIFICATION_INTENT_NOT_RECOGNIZED",
  "CLARIFICATION_REPLY_REPEATED",
  "RECENT_REPLY_REPEATED",
  "REQUIRED_PROFILE_RULE_OMITTED",
  "POLICY_TONE_TOO_LEGALISTIC",
  "INSTALLATION_OFFERED_TOO_EARLY",
  "MODEL_ACCEPTANCE_BYPASSED",
]);

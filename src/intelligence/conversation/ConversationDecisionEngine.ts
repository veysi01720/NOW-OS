...
export function buildDecisionPrompt(context: ConversationDecisionContext, repairInput?: {
  ...
  return [
    ...
    "If a private candidate explicitly corrects an already-known age, gender, or daily_hours value, state_patch must use the newly stated value with current_message evidence and next_action=update_candidate_state. Do not escalate or keep the old value merely because the field is already known.",
